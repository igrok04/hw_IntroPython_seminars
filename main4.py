...
d =  int(input("Введите заданную точность числа Пи для его вычисления :\n"))
...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("polynom_1.txt", create_str(koef1))
write_file("polynom_2.txt", create_str(koef2))

# нахождение суммы многочлена

with open('polynom_1.txt', 'r') as data:
    st1 = data.readlines()
with open('polynom_2.txt', 'r') as data:
    st2 = data.readlines()
...
write_file("polynom_res.txt", create_str(lst_new))
with open('polynom_res.txt', 'r') as data:
    st3 = data.readlines()
